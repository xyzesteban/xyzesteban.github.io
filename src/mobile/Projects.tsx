...
export default function About(props: Props) {
  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'row', height: '100%', width: '100%', backgroundColor: '#c78203', position: 'absolute' }}>
    <img
    ...
    <div className="content-section">
      {/* Add your title */}
      <Typography variant="h2" className="software-title" sx={{ color: 'white' }}>
          SOFTWARE
        </Typography>

      {/* Fading image */}
      <div className="fading-image">
        <img src="assets/Projects.png" alt="Section Image" style={{ height: 'auto', width: '100%' }} />
      </div>
