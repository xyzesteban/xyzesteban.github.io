  ...
  return (
    <Box sx={{ display: 'flex', flexDirection: 'row', height: '100%', width: '100%', backgroundColor: 'blue', position: 'absolute' }}>
      ...
      <div className="content-section">
        {/* Add your title */}
        <Typography variant="h2" className="about-title" sx={{ color: 'white' }}>
          ABOUT
        </Typography>

        {/* Fading image */}
        <div className="fading-image">
          <img src="assets/About.png" alt="Section Image" style={{ height: 'auto', width: '100%' }} />
        </div>

        {/* Scrollable list of cards */}
        <div className="card-list">
          {/* Add your cards here */}
          <Box sx={{margin: '10px', borderRadius:'15px', height:'200px', width:'90%', boxShadow: '1px 1px 2px 1.5px rgba(0, 0, 0, 0.3)', backgroundColor: 'white', position: 'relative', zIndex: 5 }}>
