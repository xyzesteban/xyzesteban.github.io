...
const About = () => {
  ...
  return (
    <ResponsiveWrapper>
      ...
      <ContentIntro>
        <p>Welcome! I’m <b>Esteban David Espinoza</b>, a software engineer with experience in full-stack web development, project management, and UI/UX research + design. I am interested in <strong>identifying problems</strong> in high-level processes and <strong>resolving them with reliable and maintainable code</strong>, to create a better experience <strong>for both users and developers.</strong><br /><br />
